...
*/
$config['tables']['users']           = TBL_AUTH_USERS;
$config['tables']['groups']          = TBL_AUTH_GROUPS;
$config['tables']['users_groups']    = TBL_AUTH_USERS_GROUPS;
$config['tables']['login_attempts']  = TBL_AUTH_LOGIN_ATTEMPTS;
 ...
 */
$config['site_title']                 = "puncoz.com";       // Site Title, example.com
$config['admin_email']                = "info@puncoz.com"; // Admin Email, admin@example.com
...
$config['max_password_length']        = 500;                  // Maximum Allowed Length of Password
